...
- [ ] **Forced subtitles** -- Generate foreign-parts-only subtitle tracks. When a movie's English audio contains scenes in Spanish, French, etc., only those non-English segments get subtitled. No existing tool does this today.
