    ...
    public static class ModelCatalog
    {
        public static readonly ModelEntry[] Models = new[]
        {
            ...
            new ModelEntry("ggml-large-v3-q5_0.bin", "Large V3 (Q5)", 1081, false,
                "Quantized full large-v3. Near-F16 accuracy at ~1/3 the size. Translation-capable; best for non-English audio. Unlike turbo, supports --translate."),
            new ModelEntry("ggml-large-v3.bin", "Large V3 (F16)", 3095, false,
                "Most accurate model. Best for non-English audio and translation; ~2x slower than turbo. Unlike turbo, supports --translate."),
