    ...
    public static class ModelCatalog
    {
        public static readonly ModelEntry[] Models = new[]
        {
            ...
            new ModelEntry("ggml-large-v3-q5_0.bin", "Large V3 (Q5)", 1081, false,
                "Quantized full large-v3 — near-F16 accuracy at ~1/3 the size and RAM. Best choice for non-English audio and translation: unlike turbo, it translates reliably.", canTranslate: true),
            new ModelEntry("ggml-large-v3.bin", "Large V3 (F16)", 3095, false,
                "Maximum accuracy, but ~3–4x slower than turbo (more on weak/iGPU hardware) and needs ~4 GB RAM. For non-English audio and translation, the Q5 version above is usually the better trade-off. Unlike turbo, it translates reliably.", canTranslate: true),
